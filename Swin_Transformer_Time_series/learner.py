...
class Learner(GetAttr):
    ...
    #        if type_ == 'train':
    #            # Print the shape of the batch here
    ...
    def test(self, dl, weight_path=None, scores=None , feature_index=0):
        """_summary_
        Args:
            test_data can be a tensor, numpy array, dataset or dataloader
        Returns:
        ...
        self('after_test') 
        self.preds = cb.preds[feature_index:feature_index+1]
        self.targets = cb.targets[ feature_index:feature_index+1]
